...
float leafX = displayWidth*1/2;
float leafY = random ( rectFaceY+measleRadius,  (rectFaceY+rectFaceDisplayHeight)-measleRadius);
...
fill(leaf);
ellipse(leafX, leafY, measleDiameter, measleDiameter);
stroke(black);
}//End measle code 
